...
const DEFAULT_CONFIG: GameConfigData = {
  ...
  enemies: {
    ...
    boss: {
      ...
      nerfFactor: 0.65,
      hpTiers: [
        { minLevel: 0, maxLevel: 30, bonusMultiplier: 1 },
        { minLevel: 30, maxLevel: 50, bonusMultiplier: 1.05 },
        { minLevel: 50, maxLevel: 75, bonusMultiplier: 1.02 },
        { minLevel: 75, maxLevel: 99, bonusMultiplier: 0.93 },
        { minLevel: 100, maxLevel: 149, bonusMultiplier: 0.9 },
    ...
    hpScaling: {
      baseHp: 100,
      tiers: [
        { maxLevel: 10, multiplier: 1.18 },
        { maxLevel: 20, multiplier: 1.45 },
        { maxLevel: 50, multiplier: 1.25 },
        ...
        { maxLevel: 85, multiplier: 1.9 },
        { maxLevel: 90, multiplier: 0.8 },
        { maxLevel: 95, multiplier: 1.3 },
